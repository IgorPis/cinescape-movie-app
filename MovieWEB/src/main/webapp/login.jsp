...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/log-reg.css" />
    ...
    <title>Login - CineScape</title>
    
     <c:if test="${not empty loggedUser}">
	    <script type="text/javascript">
	        window.location.href = "/CineScape/index.jsp"; // Redirect to home if logged in
	    </script>
	</c:if>
  </head>
  <body>
                    ...
                    <div class="account-dropdown-button">
                        ...
                        <div class="sub-menu-wrap" id="subMenu">
                            <div class="sub-menu">
                                ...
                                <a href="<c:url value='/auth/custom-logout' />" class="sub-menu-link">
                                    <span class="sub-menu-link-icon material-symbols-outlined">
                                        logout
                                    </span>
                                    <p>Log out</p>
    ...
    <main>
      <section class="section-cta" id="cta">
      	<c:if test="${param.message == 'loginFirst'}">
		    <div class="msg-box">
		        <p class="message">You must log in first to continue.</p>
		    </div>
		</c:if>
	    <c:if test="${param.error == 'true'}">
	        <c:choose>
	            <c:when test="${sessionScope.errorMessage == 'Incorrect username.'}">
	                <div class="msg-box">
	                    <p class="message">Incorrect username.</p>
	                </div>
	            </c:when>
	            <c:when test="${sessionScope.errorMessage == 'Incorrect password.'}">
	                <div class="msg-box">
...
<%--        <c:if test="${param.error == 'true'}"> --%>
<!-- 	        <div class="msg-box"> -->
<!-- 	            <p class="message">Incorrect username or password.</p> -->
<!-- 	        </div> -->
<%--         </c:if> --%>
        ...
        <c:if test="${not empty accountDeletedMessage}">
		    <div class="msg-box">
		        <p class="message">${accountDeletedMessage}</p>
		    </div>
		    <c:remove var="accountDeletedMessage" scope="session"/>
		</c:if>
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              <h2 class="heading-secondary">Log in to Your Account</h2>

              <form class="cta-form" action="<c:url value='/login' />" method="post">
                <div>
                ...
                <button class="btn btn--form">Log in</button>

                <div class="login-link-box">
                  <a href="/CineScape/auth/getAllRoles" class="link"
            ...
            <div
              class="cta-img-box login-img"
              role="img"
              aria-label="Movie watching outdoors"
            ></div>
          </div>
        </div>
      </section>
