          ...
          <div class="div-">
            <div class="cta">
              <div class="cta-text-box">
                ...
                <form class="cta-form" action="/CineScape/auth/register" enctype="multipart/form-data" method="post">
                  <div>
                  ...
                  <div>
                    ...
                    <select id="select-role" name="idRole" required>
                  ...
                  <div class="login-link-box">
                    <a href="/CineScape/auth/login" class="link"
                      >Already signed up? Log in instead</a
                    >
                  </div>
                </form>
              </div>
