...
<html lang="en">
  <head>
    ...
    <title>Edit profile - CineScape</title>
  </head>
  <body>
    <header class="header">
    ...
    <main>
      <section class="section-cta edit-profile-section" id="cta">
        <c:if test="${!empty message }">
           <div class="msg-box">
        	 <p class="message">${message }</p>
        	 <a class="link-msg" href="/CineScape/admin/getUserById?idUser=${userById.idUser}">Back to profile</a>
      	   </div>
        </c:if>
        
        <c:if test="${!empty failMsg }">
           <div class="msg-box">
        	 <p class="message">${failMsg }</p>
        	  <a class="link-msg" href="/CineScape/admin/getUserById?idUser=${userById.idUser}">Back to profile</a>
      	   </div>
        </c:if>
        <div class="container">
          <div class="div-">
            <div class="cta">
              <div class="cta-text-box">
                <h2 class="heading-secondary">Edit ${userById.username}'s profile</h2>

                <form class="cta-form" enctype="multipart/form-data" action="/CineScape/admin/updateUser/${userById.idUser}" method="post">
                  <div>
                    <label for="first-name">First Name</label>
                    <input
                      id="first-name"
                      type="text"
                      placeholder="${userById.firstName}"
                      name="firstName"
                      required
                    />
                  </div>
              ...
              <div
                class="cta-img-box admin-edit-page-img"
                role="img"
