...
<html lang="en">
  <head>
    ...
    <title>Edit movie details - CineScape</title>
  </head>
  <body>
   <header class="header">
    ...
    <main>
      <section class="section-cta edit-movie-section" id="cta">
        <c:if test="${!empty message}">
           <div class="msg-box">
        	 <p class="message">${message }</p>
        	 <a class="link-msg" href="/CineScape/user/getMovieDetails?idMovie=${movieById.idMovie}">Back to movie page</a>
      	   </div>
        </c:if>
        <div class="container">
          <div class="div-">
            <div class="cta">
              <div class="cta-text-box">
                <h2 class="heading-secondary">Edit Movie</h2>

                <form class="cta-form" enctype="multipart/form-data" action="/CineScape/admin/editMovie/${movieById.idMovie}" method="post">
                  <div>
                    <label for="title">Title</label>
                    <input
                      id="title"
                      type="text"
                      placeholder="${movieById.title}"
                      name="title"
                      required
                    />
                  </div>
                  ...
                  <div class="desc-div">
                    ...
                    <textarea
                      id="description"
                      placeholder="${movieById.description}"
                      name="description"
                      required
                    ></textarea>
                  </div>
                  <div>
                    ...
                    <input
                      id="duration"
                      type="number"
                      placeholder="${movieById.duration}"
                      name="duration"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      id="year"
                      type="number"
                      placeholder="${movieById.releaseYear}"
                      name="releaseYear"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      id="trailer"
                      type="text"
                      placeholder="${movieById.trailerKey}"
                      name="trailerKey"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select id="select-genre" name="idGenre" required>
                  ...
                  <div>
                    <label for="select-lang">Current Language: ${movieById.language.name}</label>
                    <select id="select-lang" name="idLang" required>
                      <option value="">Please choose one option:</option>
                      <c:forEach items="${langs}" var="l">
                      	<option value="${l.idLanguage}">${l.name}</option>
                      </c:forEach>
                    </select>
                  </div>
              ...
              <div
                class="cta-img-box mov-edit-page-img"
                role="img"
