...
<html lang="en">
  <head>
    ...
    <title>My Profile - CineScape</title>

    <style>
      .image {
        height: 250px;
        width: 250px;
        background-image: url("${loggedUser.imagePath}");
        ...
        <div class="ticket">
          <div class="left">
            ...
            <div class="ticket-info">
              <p class="role-text">
                <span>Role</span>
                <span class="role">${loggedUser.roleDisplayName}</span>
                <span>ID:${loggedUser.idUser}</span>
              </p>
              <div class="user-name">
              ...
              <div class="txt-sm">
                <a href="/CineScape/edit-profile-user.jsp" class="link edit-btn"
          ...
          <div class="right">
            ...
            <div class="right-info-container">
              ...
              <div class="txt-sm">
                <p>${loggedUser.roleDisplayName}</p>
              ...
              <p class="user-id">#${loggedUser.idUser}</p>
            </div>
          </div>
        </div>
      </section>
