    ...
    <main>
      <section class="section-movies" id="movies">
        <div class="movie-heading-box">
          <h2 class="heading-movies">My List
          	<c:if test="${empty favoritesOfUser}">
          	is empty, try adding some movies...</c:if>
          </h2>
        </div>

        <div class="movies-container">
        	<c:if test="${!empty favoritesOfUser }">
        		<c:forEach items="${favoritesOfUser }" var="m">
