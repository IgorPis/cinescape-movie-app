      ...
      <section class="section-cta edit-profile-section" id="cta">
        <c:if test="${!empty message }">
           <div class="msg-box">
        	 ...
        	 <a class="link-msg" href="/CineScape/user-profile-user.jsp">Back to profile</a>
      	   </div>
        </c:if>
          ...
          <div class="div-">
            <div class="cta">
              <div class="cta-text-box">
                ...
                <form class="cta-form" enctype="multipart/form-data" action="/CineScape/user/updateAccount" method="post">
                  <div>
              ...
              <div
                class="cta-img-box user-edit-page-img"
                role="img"
