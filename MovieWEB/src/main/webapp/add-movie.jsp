...
<html lang="en">
  <head>
    ...
    <title>Add movie - CineScape</title>
  </head>
  <body>
  <header class="header">
    ...
    <main>
      <section class="section-cta add-movie-section" id="cta">
          ...
          <div class="div-">
            <div class="cta">
              <div class="cta-text-box">
                <h2 class="heading-secondary">Add Movie</h2>

                <form class="cta-form" action="/CineScape/admin/addMovie" enctype="multipart/form-data" method="post">
                  <div>
                  ...
                  <div>
                    ...
                    <input id="poster" type="file" name="posterPath" required />
                  </div>
                  ...
                  <button class="btn btn--form">Add</button>
                </form>
              </div>
              <div
                class="cta-img-box mov-add-page-img"
                role="img"
