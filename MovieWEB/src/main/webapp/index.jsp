...
<html lang="en">
  <head>
    ...
    <script defer type="text/javascript"  src="${pageContext.request.contextPath}/js/sticky-now-for-index.js"></script>

    <title>CineScape - Watch Movies Online</title>
      ...
      <section class="section-hero">
        <div class="hero">
          <div class="hero-text-box">
            ...
            <a class="btn btn--full margin-right-sm" href="/CineScape/auth/getAllRoles">Join the club</a>
            <a class="btn btn--outline" href="#pricing">Learn more &darr;</a>
            <div class="customers-box">
              <div class="customer-imgs">
                <img
                  src="${pageContext.request.contextPath}/images/customers/user-1.jpg"
                  alt="User's profile picture"
                />
                <img
                  src="${pageContext.request.contextPath}/images/customers/user-2.jpg"
                  alt="User's profile picture"
                />
                <img
                  src="${pageContext.request.contextPath}/images/customers/user-3.jpg"
                  alt="User's profile picture"
                />
                <img
                  src="${pageContext.request.contextPath}/images/customers/user-4.jpg"
                  alt="User's profile picture"
                />
                <img
                  src="${pageContext.request.contextPath}/images/customers/user-5.jpg"
                  alt="User's profile picture"
                />
                <img
                  src="${pageContext.request.contextPath}/images/customers/user-6.jpg"
                  alt="User's profile picture"
                />
              </div>
          ...
          <div class="hero-img-box">
            <img
              class="hero-img"
              src="${pageContext.request.contextPath}/images/hero-min.png"
